import type { Adapter, DatabaseSession, DatabaseUser, UserId } from "npm:lucia";
import { RecordId, Table } from "npm:surrealdb.js";
import type { Surreal } from "npm:surrealdb.js";
